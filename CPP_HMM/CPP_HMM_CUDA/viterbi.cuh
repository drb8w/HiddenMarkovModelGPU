...
__global__ void viterbiKernel2D(double *dev_probs_3D, const double *dev_A_stateTransProbs_2D, const double *dev_B_obsEmissionProbs_2D, 
	unsigned int T_noOfObservations, unsigned int idx_t, unsigned int V_noOfObsSymbols);
// ------------------------------------------------------------------------------------------------------
...
// ------------------------------------------------------------------------------------------------------
__host__ __device__ void createViterbiIndices2DDevice(unsigned int &idx_a_ji, unsigned int &idx_b_it, unsigned int &idx_p, 
	unsigned int idx_i, unsigned int idx_j, unsigned int idx_t, unsigned int dim1_P, unsigned int dim2_P, unsigned int dim1_A, unsigned int dim1_B);
__host__ void createViterbiIndices2DHost(unsigned int &idx_p, unsigned int &idx_alpha_ti, unsigned int &idx_alpha_tm1j, 
	unsigned int idx_i, unsigned int idx_j, unsigned int idx_t, unsigned int dim1_Alpha, unsigned int dim1_P, unsigned int dim2_P);
// ------------------------------------------------------------------------------------------------------
__device__ void createViterbiMatrixDimensions1D(unsigned int &dim1_Alpha, unsigned int &dim2_Alpha, unsigned int &dim1_A, unsigned int &dim1_B, 
	unsigned int T_noOfObservations, unsigned int N_noOfStates, unsigned int V_noOfObsSymbols);
// ------------------------------------------------------------------------------------------------------
...
//__host__ cudaError_t ViterbiAlgorithm1DGPU(const double *dev_Pi_startProbs_1D, const double *dev_A_stateTransProbs_2D, const double *dev_B_obsEmissionProbs_2D, const unsigned int *host_O_obsSequence_1D, 
...
__host__ cudaError_t ViterbiAlgorithmSet2D(const double *host_Pi_startProbs_1D, const double *host_A_stateTransProbs_2D, const double *host_B_obsEmissionProbs_2D, const unsigned int *host_O_obsSequences_2D, 
	unsigned int N_noOfStates, unsigned int V_noOfObsSymbols, unsigned int T_noOfObservations, unsigned int M_noOfObsSequences, unsigned int *host_likeliestStateIndexSequence_2D, bool printToConsole);
// ------------------------------------------------------------------------------------------------------
