...
// version 3.0 
// ------------------------------------------------------------------------------------------------------
__host__ cudaError_t ForwardAlgorithm(const double *dev_A_stateTransProbs_2D, const double *dev_B_obsEmissionProbs_2D, const unsigned int *host_O_obsSequence_2D, int M_noOfObsSequences, int N_noOfStates, int V_noOfObsSymbols, int T_noOfObservations, unsigned int i, double * host_B, double * dev_3D_Trellis);
...
__host__ cudaError_t ForwardAlgorithmGPU(const double *dev_A_stateTransProbs_2D, const double *dev_B_obsEmissionProbs_2D, const unsigned int *host_O_obsSequence_2D, int M_noOfObsSequences, int N_noOfStates, int V_noOfObsSymbols, int T_noOfObservations, unsigned int i, double * host_B, double * dev_3D_Trellis);
